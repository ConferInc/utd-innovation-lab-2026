...
After the **April 9** cross-team schema sync, re-run scraper tests and `python -m scripts.seed_from_scraped_json --fixture` once sponsorship / payload rules change, even if you only touched scrapers indirectly.
