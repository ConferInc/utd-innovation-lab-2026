...
- Start the app using 
```bash
uvicorn 4B.week6.main:app --host 0.0.0.0 --port 8000 --reload
```
...
```YAML 
buildCommand: pip install --upgrade pip && pip install -r 4B/week6/requirements.txt
startCommand: uvicorn 4B.week6.main:app --host 0.0.0.0 --port $PORT
``` 
