...
| week7  | Event pipeline (scraping + storage + API)            | Week 7 deliverables      |
| week8  | Improvements/refactors on week7 deliverables         | Week 8 iteration         |
...
- `feature/week7-<name>-<task>` for individual work
- Merge flow: individual branch → `team-4B-week7` (or `group-4b/week7`) → PR to main
